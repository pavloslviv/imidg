...
$dt_modules['general']['doshortcode_team'] = array(
	...
	'options' => array(
		'tf_content' => array(
			...
			'type' => 'wp_editor',
			'is_content' => true,
			'default_value' => '[dt_sc_team name="DesignThemes" role="Chief Programmer" image="http'.dttheme_ssl().'://placehold.it/500" type=" / type2" twitter="#" facebook="#" google="#" linkedin="#"]
...
$dt_modules['general']['testimonial'] = array(
	...
	'options' => array(
		...
		'image' => array(
			...
			'type' => 'upload',
			'default_value' => 'http'.dttheme_ssl().'://placehold.it/300'
		),
		'tm_content' => array(
			'title' => __('Content', 'dt_themes'),
			'type' => 'wp_editor',
...
$dt_modules['general']['clients_carousel'] = array(
	...
	'options' => array(
		'cc_content' => array(
			...
			'is_content' => true,
			'default_value' => '<ul>
									<li><a href="#"><img title="Client 1" src="http'.dttheme_ssl().'://placehold.it/163x116" alt="Client 1" /></a></li>
									<li><a href="#"><img title="Client 2" src="http'.dttheme_ssl().'://placehold.it/163x116" alt="Client 2" /></a></li>
									<li><a href="#"><img title="Client 3" src="http'.dttheme_ssl().'://placehold.it/163x116" alt="Client 3" /></a></li>
									<li><a href="#"><img title="Client 4" src="http'.dttheme_ssl().'://placehold.it/163x116" alt="Client 4" /></a></li>
									<li><a href="#"><img title="Client 5" src="http'.dttheme_ssl().'://placehold.it/163x116" alt="Client 5" /></a></li>
								</ul>'
		)
	)
);
...
$dt_modules['unique']['subscription_form'] = array(
	...
	'options' => array(
		'image_url' => array(
			'title' => __('Image', 'dt_themes'),
			'type' => 'upload',
			'default_value' => 'http'.dttheme_ssl().'://placehold.it/780x502'
		),
		'slider' => array(
...
$dt_modules['others']['web'] = array(
	...
	'options' => array(
		'url' => array(
			...
			'type' => 'text',
			'default_value' => 'http'.dttheme_ssl().'://www.google.com'
		),		
	)
);
