			 ...
			 while($the_query->have_posts()): $the_query->the_post();
					...
					$out .= '<article id="post-'.get_the_ID().'" class="'.implode(" ", get_post_class("dt-sc-course", get_the_ID())).'">';
						...
						if($wooproductID != '' && $wooproductID != '-') {
							...
							$out .= '<a href="'.get_permalink($wooproductID).'" class="dt-sc-course-price">'.$wc_product->get_price_html().'</a>';
						} else {
				...
				<div class="column dt-sc-one-third no-space">
					...
					<div class="dt-sc-subscription-frm-container">
						...
						$out .= '<div id="ajax_subscribe_msg"></div>
								<button type="submit" class="dt-sc-button" value="'.$submit_text.'" name="btnsubscribe" id="btnsubscribe">'.$submit_text.'</button>
