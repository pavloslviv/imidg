			...
			if ("designthemes_sc_button" === btn) {
				...
				btn.onRenderMenu
						.add(function(c, b) {
							...
							/* Classes */
							a.addImmediate(c, "Classes", '[dt_sc_classes columns="2/3" post_per_page="-1" disable_onsiteonline_filter="true/false" disable_popularfeatured_filter="true/false" disable_listgridview="true/false" /]');
							...
							/* Quizzes */
							a.addImmediate(c, "Quizzes", '[dt_sc_quizzes quiz_ids="1,2,3" columns="1/2/3" /]');
							...
							a.addImmediate(c,"H1",'[dt_sc_h1 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h1]');
							a.addImmediate(c,"H2",'[dt_sc_h2 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h2]');
							a.addImmediate(c,"H3",'[dt_sc_h3 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h3]');
							a.addImmediate(c,"H4",'[dt_sc_h4 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h4]');
							a.addImmediate(c,"H5",'[dt_sc_h5 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h5]');
							a.addImmediate(c,"H6",'[dt_sc_h6 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h6]');
