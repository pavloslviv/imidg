 ...
 */
(function (sr) {
    sr.classes.views.DeletedProductList = sr.classes.views.ProductList.extend({
        ...
        initialize: function(data){
            ...
            this.collection = sr.data.deleted;
            if(!this.collection){
                this.collection = sr.data.deleted = new sr.classes.collections.DeletedProducts();
            } /*else {
                removed = this.collection.filter(function(p){
                    return p.get('section_id') != -1;
                });
        ...
        template: sr.core.loadTemplate('tmpl_shop_deleted_products'),
        templateRow: sr.core.loadTemplate('tmpl_shop_deleted_products_row'),
