...
(function () {
    (function (sr) {
        sr.classes.collections.Orders = sr.classes.collections.Base.extend({
            model: sr.classes.models.Order,
            loaded: false,
            ...
            fetch: function(cb){
                var that = this;
                sr.core.apiCall('shop_orders','list','POST',{filter: this.filter},function(err,r){
                    if(!err){
            ...
            fetchPage: function(number,cb){
                ...
                sr.core.apiCall('shop_orders','list','POST',{filter: this.filter, page: number},function(err,r){
                    if(!err){
